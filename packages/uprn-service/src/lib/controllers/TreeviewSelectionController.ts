...
export class TreeviewSelectionController {
	 ...
	 *
	 * @param node - The TreeviewNode to update.
	 * @param state - The desired DownloadState for the node.
	 */
	public updateSelection(node: TreeviewNode, state: SelectionState) {
	 ...
	 *
	 * @param node - The TreeviewNode to inspect.
	 ...
	 */
	private updateLayerSelection(node: LayerTreeviewNode, state: SelectionState) {
	 ...
	 *
	 * @param node - The TreeviewNode to test.
	 * @returns True if the node is a LayerTreeviewNode with type 'group'.
	 */
	private isGroupLayer(node: TreeviewNode): boolean {
		return node instanceof LayerTreeviewNode && node.layer.type === 'group';
	}
	 ...
	 *
	 * @param node - The TreeviewNode to test.
	 * @returns True if the node is a LayerTreeviewNode with sublayers.
	 */
	private hasSublayers(node: TreeviewNode): boolean {
		if (!(node instanceof LayerTreeviewNode)) return false;
	 ...
	 *
	 * @param node - The TreeviewNode to test.
	 * @returns True if the node is a LayerTreeviewNode with type 'feature'.
	 */
	private isFeatureLayer(node: TreeviewNode): boolean {
		return node instanceof LayerTreeviewNode && node.layer.type === 'feature';
	}
}
