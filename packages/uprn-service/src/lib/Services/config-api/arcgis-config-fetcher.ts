...
// 			TvTitle: String(attributes.TvTitle ?? ''),
...
// 			IsRenderedOnInit: toBoolean(attributes.IsRenderedOnInit),
// 			DisableRendering: toBoolean(attributes.DisableRendering)
// 		};
...
// 			metadataConfigUrl: raw.MetadataTabInfoUrl
// 		};
// 	}
...
// 			TvPath: String(attributes.TvPath ?? ''),
// 			Order: toNumber(attributes.Order),
// 			TvVariableName: String(attributes.TvVariableName ?? ''),
// 			TvVariableLabel: String(attributes.TvVariableLabel ?? ''),
// 			HasDependants: this.toArrayOfStrings(attributes.HasDependants),
// 			IsListed: toBoolean(attributes.IsListed),
// 			IsEnabled: toBoolean(attributes.IsEnabled),
// 			DefaultExported:
...
// 			TvVariablePath: toNullableString(attributes.TvVariablePath),
