<script lang="ts">
	import AppMapPane from '$lib/components/app/app-map-pane.svelte';
	import AppOverlays from '$lib/components/app/app-overlays.svelte';
	import AreaSelectionPanel from '$lib/components/app/area-selection-panel.svelte';
	import ChatAvailabilityPanel from '$lib/components/app/chat-availability-panel.svelte';
	import DataSelectionPanel from '$lib/components/app/data-selection-panel.svelte';
	import DownloadsPanel from '$lib/components/app/downloads-panel.svelte';
	import ExportReviewPanel from '$lib/components/app/export-review-panel.svelte';
	import TabHeaderActions from '$lib/components/app/tab-header-actions.svelte';
	...
	import { clearUprnDatabase } from '$lib/persistence/uprn-database';
	import { setItemInfoContext } from '$lib/components/item-info-dialog/item-info-context';
	...
	import { ArcgisNodeVisibilityRenderer } from '$lib/services/arcgis-node-visibility-renderer';
	import { CustomRendererService } from '$lib/services/custom-renderer-service';
	import { AreaSelectionLimitsController } from '$lib/services/area-selection-limits-controller.svelte';
	...
	import { ServiceHealthController } from '$lib/services/service-health-controller.svelte';
	...
	import { createSelectionPersistence } from '$lib/stores/selection-persistence.svelte';
	import {
		describeWebMapSource,
		getWebMapSourcePersistenceKey,
		WebMapStore
	} from '$lib/stores/web-map-store.svelte';
