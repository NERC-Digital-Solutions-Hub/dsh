<script lang="ts">
	...
	import { ArcgisMapWidgets } from './arcgis-map-widgets';
	import { applyTabInteractionMode } from './map-interaction-mode';
	import { configureMapView, loadFallbackMap } from './map-view-setup';
	import { attachNativeContextMenuBridge } from './native-context-menu-bridge';
	import UprnMapContextMenu, {
		type UprnMapContextMenuEntries
	} from './uprn-map-context-menu.svelte';
