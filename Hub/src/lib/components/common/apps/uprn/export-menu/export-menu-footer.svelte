<script lang="ts">
	...
	import { downloadsStore } from '$lib/stores/apps/uprn/downloads-store.svelte';
	...
	import ClearSelectionsButton from '$lib/components/common/apps/uprn/clear-selections-button/cl/clear-selections-button.svelte';
	import type { AreaSelectionInteractionStore } from '$lib/stores/apps/uprn/area-selection-interaction-store.svelte';
