<script lang="ts">
	...
	import { TreeLayerNode } from '$lib/components/common/apps/uprn/tree-view/types';
	import FeatureLayer from '@arcgis/core/layers/FeatureLayer';
	import FeatureLayerView from '@arcgis/core/views/layers/FeatureLayerView';
	import type { AreaSelectionStore } from '$lib/stores/apps/uprn/area-selection-store.svelte';
