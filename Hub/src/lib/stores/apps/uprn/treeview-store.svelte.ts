import type { TreeviewConfigStore } from '$lib/stores/apps/uprn/treeview-config-store.js';
import {
	TreeNode,
	TreeLayerNode,
	TreeFieldNode,
	LayerDrawState
} from '$lib/components/common/apps/uprn/tree-view/types.js';
import { type TreeviewNodeConfig, type VisibilityGroupConfig } from '$lib/types/treeview.js';
import { SvelteMap } from 'svelte/reactivity';
import type { CustomNodeConverter } from '$lib/components/common/apps/uprn/tree-view/services/custom-node-converter';
