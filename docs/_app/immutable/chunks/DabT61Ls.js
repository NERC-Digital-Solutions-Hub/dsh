import{i as v,s as d}from"./DSdBzmdi.js";import"./BFGjv385.js";const g=()=>v.getLogger("esri.views.3d.webgl-engine.core.shaderModules.shaderBuilder");class f{constructor(){this._includedModules=new Map}include(e,n){this._includedModules.has(e)?this._includedModules.get(e):(this._includedModules.set(e,n),e(this.builder,n))}}class M extends f{constructor(){super(...arguments),this.vertex=new b,this.fragment=new b,this.attributes=new A,this.varyings=new E,this.extensions=new l,this.outputs=new p}get fragmentUniforms(){return this.fragment.uniforms.entries}get attributeNames(){return this.attributes.names}get builder(){return this}generate(e,n=!1){const t=this.extensions.generateSource(e),i=this.attributes.generateSource(e),a=this.varyings.generateSource(e),s=e==="vertex"?this.vertex:this.fragment,u=s.uniforms.generateSource(),m=s.code.generateSource(),S=s.main.generateSource(n),$=e==="vertex"?x:F,_=s.constants.generateSource(),T=this.outputs.generateSource(e);return`#version 300 es
${t.join(`
`)}
${$}
${_.join(`
